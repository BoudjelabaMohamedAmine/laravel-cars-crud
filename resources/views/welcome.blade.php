...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="container fixed-top navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="/">Lovente</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-3 mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/about">Collection</a>
                    </li>
                    <li class="nav-item">
    ...
    <main class="mt-5">
        <div class="container my-auto h-full">
            <h1>Collection Car</h1>
        <div class="row text-center">
            @foreach($cars as $car)
                    ...
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{ asset('/storage/images/'.$car->image) }}" class="img-fluid" alt="{{ $car->title }}">
            ...
            @endforeach
                    ...
                    <footer class="items-center justify-center py-16 text-center text-sm text-black dark:text-white/70">
